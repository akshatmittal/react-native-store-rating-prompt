...
class RateModal extends react_1.Component {
    ...
    renderRatingView() {
        ...
        const { starLabels, isVisible, cancelButtonText, totalStarCount, defaultStars, rateButtonText, modalTitle } = this.props;
        return (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(react_native_1.View, { style: buttonContainer },
                ...
                react_1.default.createElement(Button_1.Button, { text: cancelButtonText, containerStyle: [button, buttonCancel], textStyle: buttonCancelText, onPress: this.onClosed.bind(this) }),
                react_1.default.createElement(Button_1.Button, { text: rateButtonText, containerStyle: button, onPress: this.sendRate.bind(this) }))));
    }
    renderContactFormView() {
        const { buttonContainer, button } = RateModal_1.RateModalStyles;
        const { commentPlaceholderText, sendButtonText } = this.props;
        return (react_1.default.createElement(react_1.default.Fragment, null,
            ...
            react_1.default.createElement(react_native_1.View, { style: buttonContainer },
                react_1.default.createElement(react_native_1.View, { style: { flex: 1 } }),
                react_1.default.createElement(Button_1.Button, { text: sendButtonText, containerStyle: button, onPress: this.sendContactUsForm.bind(this) }))));
    }
    renderReviewError() {
